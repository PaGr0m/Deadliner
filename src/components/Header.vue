<template>
    <div class="header gantt-elastic__header" :style="{ ...style['header'] }">
        <div
        ...
        >
                <a href="#"
                   class="alert-link text-muted mr-5"
            ...
            <label
                    class="gantt-elastic__header-task-list-switch--wrapper text-muted mr-5"
            ...
            <label
                    class="gantt-elastic__header-label text-muted"
